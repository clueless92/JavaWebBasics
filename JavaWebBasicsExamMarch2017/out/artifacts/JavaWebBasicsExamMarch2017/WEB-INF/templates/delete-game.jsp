            ...
            <div class="col-12">
                ...
                <form method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <textarea name="description" class="form-control" placeholder="Enter Game Description"
                                  minlength="20" disabled>${game.description}</textarea>
                    </div>

                    <div class="form-group row">
                        <label class="form-control-label">Thumbnail</label>
                        <input name="thumbnail" type="url" class="form-control" placeholder="Enter URL to Image"
                               value="${game.thumbnail}" disabled/>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <input name="releaseDate" type="date" class="form-control" placeholder="yyyy-MM-dd"
                               value="${game.releaseDate}" disabled/>
                    </div>
