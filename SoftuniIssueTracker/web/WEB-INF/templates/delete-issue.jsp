        ...
        <div class="jumbotron">
            <form method="post">
                <div class="form-group">
                    <input disabled name="name" type="text" class="form-control" placeholder="Enter issue name" value="${issue.name}">
                </div>
                <div class="form-group">
                    <select name="status" class="form-control" required>
                        <optgroup label="Status" disabled>
                ...
                <div class="form-group">
                    <select name="priority" class="form-control" required>
                        <optgroup label="Priority" disabled>
